...
public class Knn {
    ...
    String trainingfile ="C:\\Users\\sedan\\IdeaProjects\\kNNproject\\src\\iris_training.txt";
    String testfile ="C:\\Users\\sedan\\IdeaProjects\\kNNproject\\src\\iris_test.txt";
    ...
    public void FROMUSER(){
        ...
        while(true){
            System.out.println("enter 4 measurements with one space and use '.' instead of ',' !");
